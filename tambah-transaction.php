...
<body>
  ...
  <div class="container justify-content-center">
    <div class="row">
      <div class="col-1"></div>
      <div class="col-10 card shadow mt-5">
        <form action="controller/transaksi-store.php" method="post">
          <div class="mt-3">
            <label class="form-label" for="">Kode. Transaksi</label>
            <input class="form-control w-50" name="kode_transaksi" id="kode_transaksi" type="text"
            ...
            <table class="table table-bordered mt-3" id="table">
              ...
              <tfoot class="text-center">
                <tr>
                  ...
                  <td><input type="number" id="total_harga_keseluruhan" name="total_harga" class="form-control"
                      readonly></td>
                </tr>
                <tr>
                  <th colspan="6">Nominal Bayar</th>
                  <td><input type="number" id="nominal_bayar_keseluruhan" name="nominal_bayar" class="form-control"
                      required></td>
                </tr>
                <tr>
                  <th colspan="6">Kembalian</th>
                  <td><input type="number" class="form-control" id="kembalian_keseluruhan" name="kembalian" readonly>
                  </td>
                </tr>
              </tfoot>
            </table>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    button.addEventListener('click', function() {
      ...
      newRow += "<td>" + count + "</td>";
      newRow +=
        "<td><select class='form-control category-select' name='id_kategori[]' required>";
